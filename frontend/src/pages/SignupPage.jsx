...
//import { useAuthStore } from "../atore/useAuthStore";
...
const SignUppage = () => {
 ...
 // const [showPassword, setShowPassword] = useState(false);
  ...
  //const {sigup,isSignUp} = useAuthStore();
  //const validateForm = () => {};
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="form-control">
                ...
                <div className="relative">
                  <div className="absolute inset-y-0 left-o pl-0 flex items-center pointer-events-none">
